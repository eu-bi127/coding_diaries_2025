...
<%
	...
	int nPageNum = Integer.parseInt(pageNum);	//계산을 위해 변환. // 사용자가 선택한 페이지 번호(pageNum 문자열)를 정수로 변환하여 계산에 사용
	...
	//Board.PAGE_LINK_AMOUNT는 한 블럭당 보여줄 페이지 수
	//Math.ceil()은 소수점을 무조건 올림 처리
	...
	// 예: 현재 페이지가 6이고 블럭당 5페이지면 -> 6 / 5 = 1.2 -> 2번째 블럭
	...
	//예를 들어, 총 페이지가 13인데 현재 블럭 계산상 끝 번호가 15인 경우, 실제로 14, 15는 없는 페이지가 되므로 최대 페이지 번호(13)로 제한합니다.
