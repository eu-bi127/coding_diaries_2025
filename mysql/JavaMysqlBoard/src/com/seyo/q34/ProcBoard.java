...
public class ProcBoard {
	public static void main(String[] args) {
		...
		System.out.println("글내용을 입력해주세요:");            //글 내용 입력처리
...
//			String sql = "insert into board (b_title,b_id,b_datetime,b_text,b_hit) values ('콘솔프로그램에서쓴글','kitty',now(),'콘솔프로그램에서 작성한 글입니다. 글글.....글....',0);";
			String sql = "insert into board (b_title,b_id,b_datetime,b_text,b_hit) values ('" + title + "','kitty',now(),'" + content + "',0);";
