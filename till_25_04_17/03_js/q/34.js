...
// 데이터를 a 라는 곳에 한꺼번에 넣을 수 있다
// 그럼 a의 박스를 하나만 숫자 꺼내고 싶은데, 어떻게 하나? 
//빼는법 --> document.write(a[1]); 
// 대괄호 안에는 그 숫자를 적는게 아니라, 순서를 적어야한다.
// 계발 언어에서는 0부터 시작한다. 순서도 0번부터 시작.
// a = [5,10,15,20] 라면, 첫번째 5를 꺼내고 싶을때--> document.write(a[0]);으로 0을 넣어야한다.
// a = []에는 숫자 뿐만 아니라 글자도 넣어도 된다.
// for(var i =1;i<24;i=i_i){docunment.write(a{i})} 